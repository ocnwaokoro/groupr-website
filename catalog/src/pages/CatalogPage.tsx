  ...
  return (
    <div className="min-h-screen w-full bg-bg-primary flex flex-col text-text-primary font-sans">
      <div className="w-full min-w-0 flex flex-col items-stretch">
        ...
        <PromoBanner />
        <HeroSearch />
        <main className="w-full flex flex-col items-center flex-1 px-0 py-5 pb-20 md:max-w-[1440px] md:mx-auto md:px-section">
          <div className="w-full flex flex-col items-stretch gap-8 md:gap-16 md:max-w-[1312px]">
            <div className="w-full flex items-center justify-center py-2 md:py-8">
              <CategoryStrip />
            </div>
            <div className="w-full flex flex-col gap-8 md:gap-10 px-5 md:px-0">
              <ProductGrid />
