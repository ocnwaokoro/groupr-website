...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <Card variant="product" className="overflow-hidden flex flex-col items-start flex-shrink-0">
      ...
      <div className="self-stretch h-[140px] flex flex-col items-start justify-between px-3 py-3 box-border gap-3">
        <div className="text-text-brown text-xl font-semibold leading-[150%] text-left">
          {name}
        </div>
