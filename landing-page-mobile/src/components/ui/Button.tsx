...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses =
    'rounded-button font-sans font-semibold transition-colors text-center flex items-center justify-center min-h-[44px]';

  const variantClasses = {
    primary: 'bg-accent-orange text-text-brown hover:bg-accent-orange-dark',
    outline:
      'border-2 border-accent-orange-dark text-accent-orange bg-transparent hover:bg-accent-orange hover:text-text-brown',
  };
  ...
  const outlineLightClasses =
    'border-2 border-text-light text-text-light bg-transparent hover:bg-text-light hover:text-bg-dark';
