...
const CategoryStrip: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-full mx-auto flex items-center gap-2 min-h-[130px]">
      <button
        type="button"
        className="flex-shrink-0 w-12 h-12 flex items-center justify-center text-text-brown"
      ...
      <div
        ref={scrollRef}
        className="flex-1 min-w-0 overflow-x-auto overflow-y-hidden flex items-start gap-5 px-2 scrollbar-hide touch-pan-x"
