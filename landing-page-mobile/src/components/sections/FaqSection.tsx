...
const FaqSection: React.FC = () => {
  return (
    <section className="w-full max-w-full bg-bg-light-green overflow-hidden z-[3]">
      <div className="w-full flex flex-col items-center px-5 py-16 gap-10">
        <div className="w-full flex flex-col items-center gap-6">
          <b className="text-heading-lg font-display leading-[125%] text-text-primary">FAQs</b>
          <p className="text-base leading-[160%] font-sans text-text-brown text-center">
        ...
        <div className="w-full flex flex-col items-center gap-6 text-heading-md text-text-brown">
          <div className="flex flex-col items-center gap-4">
            <b className="text-heading-md leading-[130%] font-semibold text-center">
              Still have questions?
            </b>
            <p className="text-base leading-[160%] font-sans text-center">
          ...
          <a href="#contact">
            <Button
              variant="outline"
              size="sm"
              className="border-2 border-bg-dark text-bg-dark hover:bg-bg-dark hover:text-text-light"
            >
              Contact
            </Button>
          </a>
