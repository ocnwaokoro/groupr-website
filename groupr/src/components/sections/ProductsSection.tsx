...
const ProductsSection: React.FC = () => {
  const categories = [
    { name: 'All', icon: '/images/categories/all-category-icon.svg' },
    { name: 'Produce', icon: '/images/categories/produce-category-icon.svg' },
    { name: 'Meat & Seafood', icon: '/images/categories/meat-seafood-category-icon.svg' },
    { name: 'Pantry Staples', icon: '/images/categories/pantry-staples-category-icon.svg' },
    { name: 'Dairy & Eggs', icon: '/images/categories/dairy-eggs-category-icon.svg' },
    { name: 'Cereals & Snacks', icon: '/images/categories/cereals-snacks-category-icon.svg' },
    { name: 'Breads & Bakery', icon: '/images/categories/breads-bakery-category-icon.svg' },
    { name: 'Beverages', icon: '/images/categories/beverages-category-icon.svg' },
  ];
  ...
  return (
    <section className="w-full bg-bg-primary overflow-hidden z-[6]">
      ...
      {/* Category Row */}
      <div className="self-stretch flex items-start justify-between gap-5 text-sm">
